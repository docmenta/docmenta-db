 ...
 * @author MP
 */
public class MyVersionId implements DocVersionId
{
    public static final String DEFAULT_LATEST_VERSION_ID = "LATEST";
    private String verStr;

    public MyVersionId(String verStr) throws DocException 
    {
    ...
    {
        if (ver_str.equals(DEFAULT_LATEST_VERSION_ID)) {
            return true;
        } else {
    ...
    {
        return ver_str.equalsIgnoreCase(DEFAULT_LATEST_VERSION_ID);
    }
